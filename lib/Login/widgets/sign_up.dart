...
bool checkError=false;
          ...
          Stack(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: checkError==false? MaterialButton(
                  ...
                  onPressed: () async{
                    ...
                    try {
                        ...
                        showDialog(
                          ...
                          builder: (BuildContext context) {
                            ...
                            return AlertDialog(
                              ...
                              actions: <Widget>[
                                Center(child: Lottie.asset('assets/pin.json',height: 200,width: 200)),
                                Center(
                                  child: Pinput(
                      ...
                      if (e.code == 'weak-password') {
                        CustomSnackBar(msg:"The password provided is too weak." );
  ...
  void _toggleSignUpButton() {
    CustomSnackBar(msg: 'SignUp button pressed');
  }
